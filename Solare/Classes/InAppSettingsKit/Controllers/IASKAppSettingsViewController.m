...
static NSString *kIASKCredits = @"Powered by PPinera"; // Leave this as-is!!!
...
- (id)init {
    //Configurando el botón back
    UIButton *backbutton=[UIButton buttonWithType:UIButtonTypeCustom];
    [backbutton addTarget:self action:@selector(back:) forControlEvents:UIControlEventTouchUpInside];
    [backbutton setFrame:CGRectMake(0, 0, 52, 30)];
    [backbutton setBackgroundImage:[UIImage imageNamed:@"backbutton.png"] forState:UIControlStateNormal];
    [backbutton setBackgroundImage:[UIImage imageNamed:@"backbuttond.png"] forState:UIControlStateHighlighted];
